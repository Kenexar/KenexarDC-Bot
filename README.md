...
* [ ] `$jtc set (voicechannel id)` -> Set a Join to Create(JTC) channel. issue: <a href="/issues/18">#18</a>
...
* [ ] `$faceit_verify` -> Sets the current channel (where the message was send) to the Verify channel. issue: <a href="/issues/20">#20</a>
